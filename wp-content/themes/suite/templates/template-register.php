...
<form id="f-register" name="f-register" method="post" action="">
    <div class='head-title'>
        <div class="title">
            <h2 class="head"> <?php _e('會員註冊表', 'suite'); ?> </h2>
        </div>
    </div>
    <div class="row">
        <div class='col-md-3'><label class="label-title" for="m_user"><?php _e('User Name', 'suite'); ?> </label></div>
        <div class='col-md-9'><input type="text" class="form-control" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('User Name', 'suite'); ?>" pattern=".{2,}"
                title="minlegh 2 chars" name="m_user" id="m_user" value="<?php echo $user; ?>" /> </div>
    ...
    <div class="row">
        ...
        <div class='col-md-9'><input type="password" class="form-control" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('Password', 'suite'); ?>" name="m_pass"
                id="m_pass" value="<?php echo $pass ?>" /></div>
    ...
    <div class="row">
        ...
        <div class='col-md-9'><input type="password" class="form-control" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('Password Confirm', 'suite'); ?>"
                name="m_passf" id="m_passf" value="<?php echo $passf ?>" /></div>
        <div class='col-md-12 error-text'><label id="mes-passf"><?php echo $err_passf ?></label></div>
    </div>
    <hr /> <!-- =========    -->
    <div class="row">
        <div class='col-md-3'><label class="label-title"
                for="m_fullname"><?php _e('Full Name Chinses', 'suite'); ?></label></div>
        <div class='col-md-9'><input type="text" class="form-control" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('Full Name', 'suite'); ?>" name="m_fullname"
                id="m_fullname" value="<?php echo $fullname ?>" /></div>
        <div class='col-md-12 error-text'><label><?php echo $err_fullname ?></label></div>
    </div>
    <div class="row">
        <div class='col-md-3'><label class="label-title"
                for="m_fullname"><?php _e('Full Name English', 'suite'); ?></label></div>
        <div class='col-md-9'><input type="text" style='margin-top: -2px; width:150px'
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('姓氏', 'suite'); ?>" name="m_lastname"
                id="m_lastname" value="<?php echo $lastname ?>" /> <label> , </label>
            <input type="text" style='margin-top: -2px; width:145px'
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('名字', 'suite'); ?>" name="m_midename"
                id="m_midename" value="<?php echo $midename ?>" /> <label> - </label>
            <input type="text" style='margin-top: -2px; width:150px'
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('名字', 'suite'); ?>" name="m_firstname"
                id="m_firstname" value="<?php echo $firstname ?>" />
        </div>
    ...
    <div class="row">
        ...
        <div class='col-md-9'><input type="text" class="form-control type-number" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" pattern="[0-9]{9,9}" maxlength="9"
                placeholder="<?php _e('Passport', 'suite'); ?> " name="m_passport" id="m_passport"
                value="<?php echo $passport ?>" /></div>
    ...
    <div class="row">
        ...
        <div class='col-md-9'>
            <input type="text" class="MyDate" maxlength="10" required name="m_birthdate" id="m_birthdate"
    ...
    <div class="row">
        ...
        <div class='col-md-9'><input type="text" class="form-control" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('Address', 'suite'); ?> " name="m_address"
                id="m_address" value="<?php echo $address ?>" /></div>
    ...
    <div class="row">
        ...
        <div class=' col-md-9'><input type="text" class="form-control" required
                placeholder="<?php _e('Company', 'suite'); ?>" name="m_company" id="m_company"
                value="<?php echo $_POST['m_company'] ?>" value="<?php echo $company ?>" /></div>
    ...
    <div class="row">
        ...
        <div class=' col-md-9'><input type="text" class="form-control" required
                placeholder="<?php _e('Position', 'suite'); ?>" name="m_position" id="m_position"
                value="<?php echo $_POST['m_position'] ?>" value="<?php echo $position ?>" /></div>
    ...
    <div class="row">
        ...
        <div class='col-md-9'><input type="email" class="form-control" required
                oninvalid="this.setCustomValidity('<?php _e('Requied or Email', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('Email', 'suite'); ?>" name="m_email"
                id="m_email" value="<?php echo $email ?>" /></div>
    ...
    <div class="row">
        ...
        <div class=' col-md-9'><input type="text" required class="form-control type-phone" maxlength="20"
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" pattern="^[0-9 \-]+$"
                placeholder="<?php _e('Phone', 'suite'); ?> " name="m_phone" id="m_phone"
    ...
    <div class="row">
        ...
        <div class=' col-md-9'><input type="text" maxlength="5" required
                oninvalid="this.setCustomValidity('<?php _e('Requied', 'suite'); ?>')"
                onchange="this.setCustomValidity('')" placeholder="<?php _e('Captcha', 'suite') ?>" id="txtCaptcha"
                name="txtCaptcha" style='margin-top: -2px; margin-right:10px; width:170px'
                value="<?php echo $captcha ?>"><img src="<?php echo PART_CLASS . 'captcha/captcha.php'; ?>"
    ...
    <div class="row-register">
        <div style="text-align: center">
            <input type="submit" class="btn btn-primary" name="m_submit" id="m_submit"
                value="<?php _e('Submit', 'suite'); ?>" />
            <input type="reset" class="btn btn-primary" name="m_reset" id="m_reset"
                value="<?php _e('Reset', 'suite'); ?>" />
        </div>
    </div>
</form>
