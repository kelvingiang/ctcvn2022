...
<script>
    jQuery(document).ready(function() {
        ...
        jQuery('.summary-show').mouseenter(function() {
            jQuery(this).children('.summary-content').addClass('summary-start').removeClass('summary-close');

        }).mouseleave(function() {
            jQuery(this).children('.summary-content').addClass('summary-close').removeClass('summary-start');
