            ...
            <div class="info-bg">
                ...
                <?php if ($cate == 'dangtuyen') { ?>
                    <div class="dangtuyen">
                        ...
                        <?php if (!empty($meta['_recruit_experience'][0])) { ?>
                            <div class="row">
                                <div class="col-md-2"><label class="label-title"><?php _e('Experiences', 'suite'); ?> : </label>
                                </div>
                        ...
                        <?php if (!empty($meta['_recruit_language'][0])) { ?>
                            <div class="row">
                                <div class="col-md-2"><label class="label-title"><?php _e('Foreign Languages', 'suite'); ?> :
                                    </label></div>
                        ...
                        <?php if (!empty($meta['_recruit_work_space'][0])) { ?>
                            <div class="row">
                                <div class="col-md-2"><label class="label-title"><?php _e('Work Space', 'suite'); ?> : </label>
                                </div>
                        ...
                        <?php if (!empty($meta['_recruit_salary'][0])) { ?>
                            <div class="row">
                                <div class="col-md-2"><label class="label-title"><?php _e('Salary', 'suite'); ?> : </label>
                                </div>
                        ...
                        <?php if (!empty($meta['_recruit_orther'][0])) { ?>
                            <div class="row">
                                <div class="col-md-2"><label class="label-title"><?php _e('Another', 'suite'); ?> : </label>
                                </div>
                                <div class="col-md-10"><label <label style="word-break: break-word;">
                                        <?php echo $meta['_recruit_orther'][0]; ?></label></div>
                            </div>
                        <?php } ?>
                        <hr style="border: 2px #999 dotted">
                ...
                <?php } elseif ($cate == 'ungtuyen') { ?>
                    <div class="ungtuyen">
                        ...
                        <div class="row">
                            <div class="col-md-2"><label class="label-title"><?php _e('Brith of date', 'suite'); ?> :
                                </label></div>
