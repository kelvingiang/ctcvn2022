...
?>
        ...
        ?>
            <div id="ungtuyen_spase">
                ...
                <div class="row-one-column">
                    <div class="cell-title">
                        <label class="label-admin" style="font-weight: bold"><?php _e('Full Name'); ?></label><br />
                    </div>
                    <div class="cell-text">
                ...
                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin" style="font-weight: bold"><?php _e('Brith of date'); ?></label></div>
                    <div class="cell-text"><input type="text" name="u_birthday" id="u_birthday" readonly value="<?php echo $u_birthday ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin" style="font-weight: bold"><?php _e('Sex'); ?> </label>
                    </div>
                    <div class="cell-text"> <?php echo $u_sex == '1' ? _e('Male') : _e('Female'); ?></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"> <label class="label-admin" style="font-weight: bold"><?php _e('Address'); ?></label></div>
                    <div class="cell-text"><input type="text" name="u_address" id="u_adress" value="<?php echo $u_address ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin" style="font-weight: bold"><?php _e('Email'); ?></label></div>
                    <div class="cell-text"><input type="text" name="u_email" id="u_email" value="<?php echo $u_email ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"> <label class="label-admin" style="font-weight: bold"><?php _e('Phone'); ?></label></div>
                    <div class="cell-text"><input type="text" name="u_phone" id="u_phone" value="<?php echo $u_phone ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin" style="font-weight: bold"><?php _e('Level'); ?></label></div>
                    <div class="cell-text"><input type="text" name="u_level" id="u_level" value="<?php echo $u_level ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin" style="font-weight: bold"><?php _e('Experiences'); ?></label></div>
                    <div class="cell-text"><input type="text" name="u_experience" id="u_experience" value="<?php echo $u_experience ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label for="r_experience" class="label-admin" style="font-weight: bold"><?php _e('Another'); ?></label></div>
                    <div class="cell-text">
        ...
        <?php } elseif ($term == "dangtuyen") { ?>
            <div id="dangtuyen_space">
                <div class=" row-one-column">
                    <div class="col">
                        <div class="cell-title">
                            <label class="label-admin" style="font-weight: bold; font-size: 20px"><?php _e('Active'); ?></label>
                        </div>
                        <div class="cell-text">
                ...
                <div class="row-one-column">
                    <div class="col">
                        <div class="cell-title">
                            <label class="label-admin" style="font-weight: bold"><?php _e('Company TW'); ?></label>
                        </div>
                        <div class="cell-text">
                ...
                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('職缺名稱'); ?></label></div>
                    <div class="cell-text"><input type="text" name="d_lack_job" id="d_lack_job" value="<?php echo $d_lack_job ?>">
                    </div>
                </div>
                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('職缺人數'); ?></label></div>
                    <div class="cell-text"><input type="text" name="d_lack_count" id="d_lack_count" value="<?php echo $d_lack_count ?>"></div>
                </div>
                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('Sex'); ?></label></div>
                    <div class="cell-text">
                ...
                <div class="row-four-clo">
                    <div class="cell-title"><label class="label-admin"><?php _e('有效日期'); ?></label></div>
                    <div class="cell-text"><input type="text" class="MyDate" maxlength="10" name="d_date_from" id="d_date_from" value="<?php echo $d_date_from ?>"> </div>
                    <div class="cell-three"><label class="label-admin"><?php _e('To'); ?></label></div>
                    <div class="cell-four"><input type="text" class="MyDate" maxlength="10" name="d_date_to" id="d_date_to" value="<?php echo $d_date_to ?>"> </div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('Level'); ?></label></div>
                    <div class="cell-text"><input type="text" class="form-control" name="d_level" id="d_level" value="<?php echo $d_level ?>"></div>
                </div>
                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('Experiences'); ?></label></div>
                    <div class="cell-text"><input type="text" class="form-control" name="d_experience" id="d_experience" value="<?php echo $d_experience ?>"></div>
                </div>

                <div class="row-four-clo">
                    <div class="cell-title"><label class="label-admin"><?php _e('Age'); ?></label></div>
                    <div class="cell-text"><input type="text" class="type-number" maxlength="2" name="d_age_from" id="d_age_from" value="<?php echo $d_age_from ?>"></div>
                    <div class="cell-three"><label class="label-admin"><?php _e('To'); ?></label></div>
                    <div class="cell-four"><input type="text" class="type-number " maxlength="2" name="d_age_to" id="d_age_to" value="<?php echo $d_age_to ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('Foreign Languages'); ?></label></div>
                    <div class="cell-text"><input type="text" class="form-control" name="d_language" id="d_language" value="<?php echo $d_language ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin"><?php _e('Work Space'); ?></label></div>
                    <div class="cell-text"><input type="text" class="form-control" name="d_work_space" id="d_work_space" value="<?php echo $d_work_space ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"> <label class="label-admin"><?php _e('Salary'); ?></label></div>
                    <div class="cell-text"><input type="text" class="form-control" name="d_salary" id="d_salary" value="<?php echo $d_salary ?>"></div>
                </div>

                <div class="row-one-column">
                    <div class="cell-title"><label class="label-admin" style="font-weight: bold"><?php _e('Another'); ?></label></div>
                    <div class="cell-text">
