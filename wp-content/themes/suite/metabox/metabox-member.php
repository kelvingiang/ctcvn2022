...
?>
        ...
        <div class="row-one-column">
            <div class="col">
                ...
                <div class="cell-text"><input type="email" class="my-input" required placeholder="小心輸入,此欄目以後不可修改" name="m_email" id="m_email" <?php echo $m_email == '' ? '' : 'readonly' ?> value="<?php echo ((!isset($m_email) || $m_email != '') ? $m_email : ''); ?>" /></div>
