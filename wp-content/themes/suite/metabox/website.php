...
class Admin_Metabox_website {
    ...
    public function display($post) {
        ...
        echo '<p><i> 輸入整個網站的地址如 : http://yahoo.com </i></p>';
        $objhtml = new MyHtml();
        ...
        echo '<div class="row-one-clo">'
        . '<div class="cell-one"><label class="label-admin" for ="' . $inputID . '">' . translate('網站地址') . ' </label></div>'
        . '<div class="cell-two">' . $objhtml->textbox($inputName, $inputvalue, $arr) . '</div>'
        . '</div>';
    }
