...
?>
<div
    style=" background-color: #FFADAD; color: white; min-height: 150px; margin-left: -20px; margin-bottom: 50px; padding-left: 20px">
    <?php
...
<form action="" method="post" enctype="multipart/form-data" id="f-guests" name="f-guests">
    <div class="row-one-clo" style=" margin-top: 3rem ">
        ...
        <div class="cell-two">
            ...
            <div id="show-img" style=" background-image: url('<?php echo PART_IMAGES_GUESTS . $guest_img; ?>');">
            </div>
    ...
    <div class="row-one-clo" style=" height: 50px">
        ...
        <div class="cell-two">
            ...
            <div style=" float: left; margin-right: 20px">
                <img id="img_barcode" name="img_barcode" src='<?php echo get_qrcode_img($data['barcode']); ?>'
                    style="width: 50px">
            </div>
            <div>
    ...
    <div class="row-one-clo">
        ...
        <div class="cell-two"><input type="text" id="txt_appcode" name="txt_appcode"
                <?php echo get_current_user_id() == 1 ? '' : 'readonly' ?> value="<?php echo $data['app_code'] ?>" />
        </div>
    </div>

    <div class="row-one-clo">
        <div class="cell-one "><label class="label-admin"> <?php _e('Full Name') ?> </label></div>
        <div class="cell-two"><input type="text" id="txt_fullname" name="txt_fullname" required
                value="<?php echo $data['full_name'] ?>" /></div>
    </div>
    ...
    <div class="row-one-clo">
        ...
        <div class="cell-two"><input type="text" id="txt_position" name="txt_position"
                value='<?php echo $data['position'] ?>' /></div>
    </div>
    ...
    <div class="row-one-clo">
        ...
        <div class="cell-two"><input type="text" id="txt_phone" name="txt_phone" class='type-phone-more'
                value='<?php echo $data['phone']; ?>' /></div>
    </div>
