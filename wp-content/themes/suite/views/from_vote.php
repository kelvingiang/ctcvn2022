...
<div style="padding-top: 20px">
    ...
    <form action="" method="post" enctype="multipart/form-data" id="f-vote" name="f-vote">
        ...
        <div class="row-one-column">
            <div class="col">
                <div class="cell-title "><label class="label-admin">候選職位</label></div>
                <div class="cell-text">
        ...
        <div class="row-one-column">
            <div class="col"></div>
            <div class="cell-title "><label class="label-admin">姓名</label></div>
            <div class="cell-text">
        ...
        <div class="row-one-column">
            <div class="col"></div>
            <div class="cell-title "><label class="label-admin">公司名稱</label></div>
            <div class="cell-text"><input type="text" id="txt_company" name="txt_company" class="my-input" value="<?php echo $item['company'] ?>" /></div>
        </div>

        <div class="row-one-column">
            <div class="col"></div>
            <div class="cell-title "><label class="label-admin">同意票數</label></div>
            <div class="cell-text"><input type="text" id="txt_agree" name="txt_agree" class=" type-number" value="<?php echo $item['agree'] ?>" /></div>
        </div>

        <div class="row-one-column">
            <div class="col"></div>
            <div class="cell-title "><label class="label-admin">不同意票數</label></div>
            <div class="cell-text"><input type="text" id="txt_not_agree" name="txt_not_agree" class=" type-number" value="<?php echo $item['not_agree'] ?>" /></div>
        </div>

        <div class="row-one-column">
            <div class="col"></div>
            <div class="cell-title "><label class="label-admin">廢票數</label></div>
            <div class="cell-text"><input type="text" id="txt_illegal" name="txt_illegal" class=" type-number" value="<?php echo $item['illegal'] ?>" /></div>
        </div>

        <div class="row-one-column">
            <div class="col"></div>
            <div class="cell-title "><label class="label-admin">總票數</label></div>
            <div class="cell-text"><input type="text" id="txt_total" name="txt_total" class=" type-number" value="<?php echo $item['total'] ?>" /></div>
        </div>
